/**
 * @file PBF003_00G_CBQuery.cpp
 */
#include "PBF003_00G_CBQuery.h"

int PFB003_00G_Query_Common(pmbuscmd_t* pmbuscmd, wchar_t* string, unsigned int sizeOfstr);

int PFB003_00G_Query_0900H(pmbuscmd_t* pmbuscmd, wchar_t* string, unsigned int sizeOfstr){ return PFB003_00G_Query_Common(pmbuscmd, string, sizeOfstr); }
int PFB003_00G_Query_0902H(pmbuscmd_t* pmbuscmd, wchar_t* string, unsigned int sizeOfstr){ return PFB003_00G_Query_Common(pmbuscmd, string, sizeOfstr); }
int PFB003_00G_Query_0904H(pmbuscmd_t* pmbuscmd, wchar_t* string, unsigned int sizeOfstr){ return PFB003_00G_Query_Common(pmbuscmd, string, sizeOfstr); }
int PFB003_00G_Query_0905H(pmbuscmd_t* pmbuscmd, wchar_t* string, unsigned int sizeOfstr){ return PFB003_00G_Query_Common(pmbuscmd, string, sizeOfstr); }
int PFB003_00G_Query_0906H(pmbuscmd_t* pmbuscmd, wchar_t* string, unsigned int sizeOfstr){ return PFB003_00G_Query_Common(pmbuscmd, string, sizeOfstr); }
int PFB003_00G_Query_0907H(pmbuscmd_t* pmbuscmd, wchar_t* string, unsigned int sizeOfstr){ return PFB003_00G_Query_Common(pmbuscmd, string, sizeOfstr); }
int PFB003_00G_Query_0908H(pmbuscmd_t* pmbuscmd, wchar_t* string, unsigned int sizeOfstr){ return PFB003_00G_Query_Common(pmbuscmd, string, sizeOfstr); }
int PFB003_00G_Query_0909H(pmbuscmd_t* pmbuscmd, wchar_t* string, unsigned int sizeOfstr){ return PFB003_00G_Query_Common(pmbuscmd, string, sizeOfstr); }
int PFB003_00G_Query_0910H(pmbuscmd_t* pmbuscmd, wchar_t* string, unsigned int sizeOfstr){ return PFB003_00G_Query_Common(pmbuscmd, string, sizeOfstr); }
