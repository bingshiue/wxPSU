...
ReceiveISPStartCMDTask::ReceiveISPStartCMDTask(IOACCESS* ioaccess, unsigned int* currentIO, PMBUSSendCOMMAND_t pmbusSendCommand, tihex<> *tiHexFileStat, unsigned char* ispStatus, unsigned char target){
