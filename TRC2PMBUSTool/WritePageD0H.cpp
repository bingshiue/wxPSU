...
void WritePageD0H::OnButtonWrite(wxCommandEvent& event){
	...
	CMDD0H.m_bytesToRead = PMBUSHelper::GetBytesToReadOfWriteCMD(*this->m_currentIO, CMD_D0H_BYTES_TO_READ);//(*this->m_currentIO == IOACCESS_SERIALPORT) ? CMD_D0H_BYTES_TO_READ : CMD_D0H_BYTES_TO_READ+1;
