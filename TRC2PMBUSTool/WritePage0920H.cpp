...
#define DEFAULT_HIGH_BYTE_VALUE   1056/**< Default high byte Value */
#define DEFAULT_LOW_BYTE_VALUE    0x00/**< Default low  byte Value */

#define WRITE_PAGES_0920H_DEFAULT_FORMAT_HEX  FALSE//TRUE//FALSE

#define MAX_INPUT_VALUE  2000/**< Max Input Value */
#define MIN_INPUT_VALUE   500/**< Min Input Value */
...
void WritePage0920H::OnTargetValue(wxCommandEvent& event) {
	PSU_DEBUG_PRINT(MSG_DEBUG, "");
...
void WritePage0920H::OnButtonWrite(wxCommandEvent& event){
	...
	CMD0920H.m_sendCommand = SELF_CMD;
	...
	if (*this->m_monitor_running == true){
		...
		new(TP_SendWriteCMDTask) SendWriteCMDTask(m_ioaccess, m_currentIO, CMD0920H, true);
	}
...
EVT_TEXT(CID_TEXTCTRL_TARGET_VALUE, WritePage0920H::OnTargetValue)
