...
int PFB003_00G_Coefficients_0922H(pmbuscmd_t* pmbuscmd, wchar_t* string, unsigned int sizeOfstr);
int PFB003_00G_Coefficients_0923H(pmbuscmd_t* pmbuscmd, wchar_t* string, unsigned int sizeOfstr);
