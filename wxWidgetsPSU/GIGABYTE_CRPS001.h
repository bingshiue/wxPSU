...
PMBUSCOMMAND_t g_GIGABYTE_CRPS001_CMDTable[] = { 
	// toggle  Label, Register  Name  Access Query  Cook  Raw  ResponseDataLength  RECVBUFF_t  CMDSTATUS_t CMDCBFUNC_t  wxPanel(Write Page) wxPanel(Read Page)
	// 00H [0]
	...
	// 06H [3]
	{ true, "06H", 0x06, "PAGE_PLUS_READ", cmd_access_bwr_read, 0, 0, { 0 }, 0x04, { 0 }, { cmd_status_not_run, cmd_also_send_write_data, 0x03, { 0x02, 0x00, 0x79 }, cmd_no_need_change_page, 0 }, { 0 }, NULL, NULL },
	// 19H [4]
	...
	// 1BH [6]
	{ true, "1BH", 0x1b, "SMBALERT_MASK", cmd_access_bwr_readwrite, 0, 0, { 0 }, 0x03, { 0 }, { cmd_status_not_run, cmd_also_send_write_data, 0x02, { 0x01, 0x78 }, cmd_no_need_change_page, 0 }, { 0 }, NULL, NULL },
	// 20H [7]
	{ true, "20H", 0x20, "VOUT_MODE", cmd_access_read, 0, 0, { 0 }, 0x02, { 0 }, { 0 }, { 0 }, NULL, NULL },
	// 30H [8]
	{ true, "30H", 0x30, "COEFFICIENTS", cmd_access_bwr_read, 0, 0, { 0 }, 0x07, { 0 }, { cmd_status_not_run, cmd_also_send_write_data, 0x03, { 0x02, 0x86, 0x00 }, cmd_no_need_change_page, 0 }, { 0 }, NULL, NULL },
	// 31H 
