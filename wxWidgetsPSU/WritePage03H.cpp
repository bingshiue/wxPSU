...
void WritePage03H::OnButtonWrite(wxCommandEvent& event){
	...
	unsigned char SendBuffer[8] = {
		0x41, 0x54, 0xB6, 0x03, clearFaultValue, 0x00, 0x0D, 0x0A
	};
	...
	CMD03H.m_sendDataLength = sizeof(SendBuffer) / sizeof(SendBuffer[0]);
	CMD03H.m_bytesToRead = CMD_03H_BYTES_TO_READ;
