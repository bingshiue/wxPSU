 ...
 * @file FSG003_000G.h
 */
#ifndef _FSG003_000G_H_
#define _FSG003_000G_H_

#include "PMBUSCommandType.h"
#include "PMBUSCMDWritePages.h"

#define FSG003_000G_MODEL_NAME      L"FSG003_000G"

PMBUSCOMMAND_t g_FSG003_000G_CMDTable[] = { //[FSG003_000G_CMD_TABLE_SIZE] = {
	...
	// 01H
	{ true, "01H", 0x01, "OPERATION", cmd_access_readwrite, 0, 0, { 0 }, 0x02, { 0 }, { 0 }, { 0 }, NULL, NULL },
	// 02H
	{ true, "02H", 0x02, "ON_OFF_CONFIG", cmd_access_readwrite, 0, 0, { 0 }, 0x02, { 0 }, { 0 }, { 0 }, NULL, NULL },
	// 03H
	{ true, "03H", 0x03, "CLEAR_FAULTS", cmd_access_write, 0, 0, { 0 }, 0x05, { 0 }, { 0 }, { 0 }, NULL, NULL },
	// 1BH
	{ true, "1BH", 0x1b, "SMRALERT_MASK", cmd_access_readwrite, 0, 0, { 0 }, 0x03, { 0 }, { cmd_status_not_run, cmd_also_send_write_data, 0x02, { 0x01, 0x78 }, cmd_no_need_change_page, 0 }, { 0 }, NULL, NULL },
	// 20H
	...
	// 7Fh         
	{ true, "7FH", 0x7f, "STATUS OTHER", cmd_access_read, 0, 0, { 0 }, 0x02, { 0 }, { 0 }, { 0 }, NULL, NULL },
	// 81h         
	...
	// 8Ah         
	{ true, "8AH", 0x8a, "READ VCAP", cmd_access_read, 0, 0, { 0 }, 0x03, { 0 }, { 0 }, { 0 }, NULL, NULL },
	// 8Bh (00h)   
	...
	// 99h         
	{ true, "99H", 0x99, "MFR_ID", cmd_access_brbw, 0, 0, { 0 }, 0x07, { 0 }, { 0 }, { 0 }, NULL, NULL },
	// 9Ah         
	...
	// 9Ch         
	{ true, "9CH", 0x9c, "MFR_LOCATION", cmd_access_brbw, 0, 0, { 0 }, 0x05, { 0 }, { 0 }, { 0 }, NULL, NULL },
	// 9Dh         
	{ true, "9DH", 0x9d, "MFR_DATE", cmd_access_brbw, 0, 0, { 0 }, 0x08, { 0 }, { 0 }, { 0 }, NULL, NULL },
	// 9Eh         
	...
	// DBh         
	{ true, "DBH", 0xdb, "Read_RealTime", cmd_access_read, 0, 0, { 0 }, 0x05, { 0 }, { 0 }, { 0 }, NULL, NULL },
	// DCh         
	{ true, "DCH", 0xdc, "Read_BoxSTATUS", cmd_access_readwrite, 0, 0, { 0 }, 0x0C, { 0 }, { 0 }, { 0 }, NULL, NULL },
	// DDh         
	{ true, "DDH", 0xdd, "Black_BOX_Index", cmd_access_readwrite, 0, 0, { 0 }, 0x02, { 0 }, { 0 }, { 0 }, NULL, NULL },
	// F5h         
	{ true, "F5H", 0xf5, "Firmware_Version_Command", cmd_access_br, 0, 0, { 0 }, 0x06, { 0 }, { 0 }, { 0 }, NULL, NULL },
	// FAh         
	{ true, "FAH", 0xfa, "Firmware_Update_Command", cmd_access_readwrite, 0, 0, { 0 }, 0x02, { 0 }, { 0 }, { 0 }, NULL, NULL },
	// FCh         
	{ true, "FCH", 0xfc, "Firmware_Update Status", cmd_access_read, 0, 0, { 0 }, 0x02, { 0 }, { 0 }, { 0 }, NULL, NULL },

};

#define FSG003_000G_CMD_TABLE_SIZE  sizeof(g_FSG003_000G_CMDTable)/sizeof(PMBUSCOMMAND_t) //62
