/**
 * @file PMBUSStatusDCHPanel.h
 */
#ifndef _PMBUSSTATUSDCHPANEL_H_
#define _PMBUSSTATUSDCHPANEL_H_
...
class PMBUSStatusDCHPanel : public wxScrolledWindow {
public:
	/**
	* @brief Constructor.
	*/
	PMBUSStatusDCHPanel(wxWindow* parent);
	/**
	* @brief Deconstructor.
	*/
	~PMBUSStatusDCHPanel();
	...
	// Status_VOUT 1
	wxGridSizer *m_statusVout1_GS_1;
	wxStaticBoxSizer *m_statusVout1SBS;

	wxBoxSizer *m_statusVout1_HS_1;
	wxBoxSizer *m_statusVout1_HS_2;
	wxBoxSizer *m_statusVout1_HS_3;
	wxBoxSizer *m_statusVout1_HS_4;
	wxBoxSizer *m_statusVout1_HS_5;
	wxBoxSizer *m_statusVout1_HS_6;
	wxBoxSizer *m_statusVout1_HS_7;
	wxBoxSizer *m_statusVout1_HS_8;

	wxStaticBitmap *m_stbVOUT_OV_FAULT_Vout1;
	wxStaticBitmap *m_stbVOUT_OV_WARNING_Vout1;
	wxStaticBitmap *m_stbVOUT_UV_WARNING_Vout1;
	wxStaticBitmap *m_stbVOUT_UV_FAULT_Vout1;
	wxStaticBitmap *m_stbVOUT_MAX_Vout1;
	wxStaticBitmap *m_stbTON_MAX_FAULT_Vout1;
	wxStaticBitmap *m_stbTOFF_MAX_WARNING_Vout1;
	wxStaticBitmap *m_stbVOUT_TRACKING_ERROR_Vout1;

	wxStaticText *m_stVOUT_OV_FAULT_Vout1;
	wxStaticText *m_stVOUT_OV_WARNING_Vout1;
	wxStaticText *m_stVOUT_UV_WARNING_Vout1;
	wxStaticText *m_stVOUT_UV_FAULT_Vout1;
	wxStaticText *m_stVOUT_MAX_Vout1;
	wxStaticText *m_stTON_MAX_FAULT_Vout1;
	wxStaticText *m_stTOFF_MAX_WARNING_Vout1;
	wxStaticText *m_stVOUT_TRACKING_ERROR_Vout1;

	// Status_VOUT 2
	wxGridSizer *m_statusVout2_GS_1;
	wxStaticBoxSizer *m_statusVout2SBS;

	wxBoxSizer *m_statusVout2_HS_1;
	wxBoxSizer *m_statusVout2_HS_2;
	wxBoxSizer *m_statusVout2_HS_3;
	wxBoxSizer *m_statusVout2_HS_4;
	wxBoxSizer *m_statusVout2_HS_5;
	wxBoxSizer *m_statusVout2_HS_6;
	wxBoxSizer *m_statusVout2_HS_7;
	wxBoxSizer *m_statusVout2_HS_8;

	wxStaticBitmap *m_stbVOUT_OV_FAULT_Vout2;
	wxStaticBitmap *m_stbVOUT_OV_WARNING_Vout2;
	wxStaticBitmap *m_stbVOUT_UV_WARNING_Vout2;
	wxStaticBitmap *m_stbVOUT_UV_FAULT_Vout2;
	wxStaticBitmap *m_stbVOUT_MAX_Vout2;
	wxStaticBitmap *m_stbTON_MAX_FAULT_Vout2;
	wxStaticBitmap *m_stbTOFF_MAX_WARNING_Vout2;
	wxStaticBitmap *m_stbVOUT_TRACKING_ERROR_Vout2;

	wxStaticText *m_stVOUT_OV_FAULT_Vout2;
	wxStaticText *m_stVOUT_OV_WARNING_Vout2;
	wxStaticText *m_stVOUT_UV_WARNING_Vout2;
	wxStaticText *m_stVOUT_UV_FAULT_Vout2;
	wxStaticText *m_stVOUT_MAX_Vout2;
	wxStaticText *m_stTON_MAX_FAULT_Vout2;
	wxStaticText *m_stTOFF_MAX_WARNING_Vout2;
	wxStaticText *m_stVOUT_TRACKING_ERROR_Vout2;

	// Status_IOUT 1
	wxGridSizer *m_statusIout1_GS_1;
	wxStaticBoxSizer *m_statusIout1SBS;

	wxBoxSizer *m_statusIout1_HS_1;
	wxBoxSizer *m_statusIout1_HS_2;
	wxBoxSizer *m_statusIout1_HS_3;
	wxBoxSizer *m_statusIout1_HS_4;
	wxBoxSizer *m_statusIout1_HS_5;
	wxBoxSizer *m_statusIout1_HS_6;
	wxBoxSizer *m_statusIout1_HS_7;
	wxBoxSizer *m_statusIout1_HS_8;

	wxStaticBitmap *m_stbIOUT_OC_FAULT_Iout1;
	wxStaticBitmap *m_stbIOUT_OC_LV_FAULT_Iout1;
	wxStaticBitmap *m_stbIOUT_OC_WARNING_Iout1;
	wxStaticBitmap *m_stbIOUT_UC_FAULT_Iout1;
	wxStaticBitmap *m_stbCURRENT_SHARE_FAULT_Iout1;
	wxStaticBitmap *m_stbIN_POWER_LIMITING_Iout1;
	wxStaticBitmap *m_stbPOUT_OC_FAULT_Iout1;
	wxStaticBitmap *m_stbPOUT_OP_WARNING_Iout1;

	wxStaticText *m_stIOUT_OC_FAULT_Iout1;
	wxStaticText *m_stIOUT_OC_LV_FAULT_Iout1;
	wxStaticText *m_stIOUT_OC_WARNING_Iout1;
	wxStaticText *m_stIOUT_UC_FAULT_Iout1;
	wxStaticText *m_stCURRENT_SHARE_FAULT_Iout1;
	wxStaticText *m_stIN_POWER_LIMITING_Iout1;
	wxStaticText *m_stPOUT_OC_FAULT_Iout1;
	wxStaticText *m_stPOUT_OP_WARNING_Iout1;

	// Status_IOUT 2
	wxGridSizer *m_statusIout2_GS_1;
	wxStaticBoxSizer *m_statusIout2SBS;

	wxBoxSizer *m_statusIout2_HS_1;
	wxBoxSizer *m_statusIout2_HS_2;
	wxBoxSizer *m_statusIout2_HS_3;
	wxBoxSizer *m_statusIout2_HS_4;
	wxBoxSizer *m_statusIout2_HS_5;
	wxBoxSizer *m_statusIout2_HS_6;
	wxBoxSizer *m_statusIout2_HS_7;
	wxBoxSizer *m_statusIout2_HS_8;

	wxStaticBitmap *m_stbIOUT_OC_FAULT_Iout2;
	wxStaticBitmap *m_stbIOUT_OC_LV_FAULT_Iout2;
	wxStaticBitmap *m_stbIOUT_OC_WARNING_Iout2;
	wxStaticBitmap *m_stbIOUT_UC_FAULT_Iout2;
	wxStaticBitmap *m_stbCURRENT_SHARE_FAULT_Iout2;
	wxStaticBitmap *m_stbIN_POWER_LIMITING_Iout2;
	wxStaticBitmap *m_stbPOUT_OC_FAULT_Iout2;
	wxStaticBitmap *m_stbPOUT_OP_WARNING_Iout2;

	wxStaticText *m_stIOUT_OC_FAULT_Iout2;
	wxStaticText *m_stIOUT_OC_LV_FAULT_Iout2;
	wxStaticText *m_stIOUT_OC_WARNING_Iout2;
	wxStaticText *m_stIOUT_UC_FAULT_Iout2;
	wxStaticText *m_stCURRENT_SHARE_FAULT_Iout2;
	wxStaticText *m_stIN_POWER_LIMITING_Iout2;
	wxStaticText *m_stPOUT_OC_FAULT_Iout2;
	wxStaticText *m_stPOUT_OP_WARNING_Iout2;
